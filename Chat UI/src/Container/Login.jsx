                        ...
                        <div className="mt-7 rounded p-5 login-form bg-white w-full h-auto">
                            <form className="max-w-xl mx-auto" onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <div className="w-full flex">
                                    <NavLink className={'text-[13px] mb-3 text-[blue]'} to='/register'>Register</NavLink>
                                </div>

                                <button type="submit" className="text-white bg-[#008069] hover:bg-[#008075] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login</button>
                            </form>
